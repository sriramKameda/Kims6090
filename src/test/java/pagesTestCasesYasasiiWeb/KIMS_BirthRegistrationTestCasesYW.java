...
public void BirthReg(String title , String NAME ,String lastName, String DOB , String MBLNO , String ADDRESS , String DOCno,String MRNO, String Provider , String MRNo1, String ADTprovider,String nurseUser, String password ,String AdminUser , String AdminPassword,String DOCuser , String DOCpassword, String Site,String MRDUser, String MRDPassword,String FinalbillUser ) throws InterruptedException, IOException, AWTException {
		Thread.sleep(2000);
...
public void Doctornote(String title , String NAME ,String lastName, String DOB , String MBLNO , String ADDRESS , String DOCno,String MRNo, String Provider , String MRNo1, String ADTprovider,String nurseUser, String password ,String AdminUser , String AdminPassword,String DOCuser , String DOCpassword, String Site,String MRDUser, String MRDPassword,String FinalbillUser ) throws InterruptedException, IOException, AWTException {
		Thread.sleep(5000);
...
public void babynote(String title , String NAME ,String lastName, String DOB , String MBLNO , String ADDRESS , String DOCno,String MRNO, String Provider , String MRNo1, String ADTprovider,String nurseUser, String password ,String AdminUser , String AdminPassword,String DOCuser , String DOCpassword, String Site,String MRDUser, String MRDPassword,String FinalbillUser ) throws InterruptedException, IOException {
		Thread.sleep(5000);
...
public void Babydischarge(String title , String NAME ,String lastName, String DOB , String MBLNO , String ADDRESS , String DOCno,String MRNo,String Provider , String MRNo1, String ADTprovider,String nurseUser, String password ,String AdminUser , String AdminPassword,String DOCuser , String DOCpassword, String Site,String MRDUser, String MRDPassword,String FinalbillUser ) throws InterruptedException, IOException, AWTException {
		Thread.sleep(2000);
...
public void MOMdischarge(String title , String NAME ,String lastName, String DOB , String MBLNO , String ADDRESS , String DOCno,String MRNo, String Provider , String MRNo1, String ADTprovider,String nurseUser, String password ,String AdminUser , String AdminPassword,String DOCuser , String DOCpassword, String Site,String MRDUser, String MRDPassword,String FinalbillUser ) throws InterruptedException, IOException, AWTException {
	    ...
	    Schedule.dischargeApprovalMOM(MRNo1, nurseUser, MRDPassword, AdminUser, AdminPassword);
