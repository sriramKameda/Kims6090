...
public class KIMS_Inventory_yasasiiweb extends PageFactoryInitYasasiiWeb{
	...
	public WebElement Pharmlocation;
	
	//div[@class='form-group zero-bottom ki-dropdown']//input[@id='phreqlocid']
...
//		Thread.sleep(800);
		...
		ItemName.click();
		Thread.sleep(800);
		ItemName.sendKeys("WAXONIL O KID EAR DROPS" , Keys.ENTER);
		Thread.sleep(800);
		driver.findElement(By.xpath("//div[@class='displaing-item']")).click();
		Thread.sleep(800);
		MINqty.click();
	...
	public void  inventoryIndednt() throws InterruptedException, AWTException {
		...
		IssuingLoc.click();
		Thread.sleep(800);
		IssuingLoc.sendKeys(Inventoryissuelocation);
		Thread.sleep(800);
		driver.findElement(By.xpath("//li[normalize-space()='"+Inventoryissuelocation+"']")).click();	
		Thread.sleep(800);
		ItemName.click();
		...
		ItemName.click();
		Thread.sleep(800);
		ItemName.sendKeys("MIRAGO 25MG TAB" , Keys.ENTER);
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[@class='displaing-item']")).click();
		Thread.sleep(800);
		IndentQTY.click();
...
//		String IndentNO = word[1];
	...
	public void PatientIndent(String MRNo) throws InterruptedException, AWTException, IOException {
		...
		ItemName.click();
		Thread.sleep(800);
		ItemName.sendKeys("MORPHINE 50MG TAB" , Keys.ENTER);
		Thread.sleep(800);
		driver.findElement(By.xpath("//div[@class='displaing-item']")).click();
		Thread.sleep(800);
		IndentQTY.click();
	...
	public void IndentGroup(String IndGroupName) throws InterruptedException, AWTException {
		...
		Thread.sleep(800);	
		IndgrpItemSearch.sendKeys("MIRAGO 25MG TAB");
		Thread.sleep(800);
		Search.click();
		Thread.sleep(2000);
		Pencil1.click();
